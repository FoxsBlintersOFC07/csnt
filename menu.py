...
libs = ['requests', 'platform', 'os', 'sys', 'random', 'json', 'time', 'base64', 're', 'colorama', 'threading', 'playsound'] # lista de bibliotecas a serem verificadas
...
def instalação():
    ...
    os.system ('pip install requests colorama playsound')
    menu()
