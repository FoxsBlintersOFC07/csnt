...
def play_script():
    playsound.playsound('script.mp3',block=False)

def play_bv():
    sons = ["Bv1.mp3", "Bv2.mp3", "Bv3.mp3", "Bv4.mp3"] # Lista de arquivos de som
    som_escolhido = random.choice(sons) # Escolhe um arquivo de som aleatoriamente
    playsound.playsound(som_escolhido, block=False) # Executa o arquivo de som escolhido
...
startscreen()
os.system('cls')
os.system('title Consultas_BLT.py {-+-} Foxs Blinters, New Hacker legion')
play_bv()
menu()
